...
MACRO ( GENERATE_FORTRAN_HEADER name
  ...
  ADD_CUSTOM_COMMAND (
    ...
    COMMAND genheader_pmmg2d ${out_dir}/${out_file} ${in_dir}/${in_file} ${include_dir}
    ${PROJECT_SOURCE_DIR}/scripts/genfort.pl
    WORKING_DIRECTORY ${PROJECT_BINARY_DIR}
    DEPENDS genheader_pmmg2d ${in_dir}/${in_file}
    ${PROJECT_SOURCE_DIR}/scripts/genfort.pl
...
MACRO ( COPY_HEADERS_AND_CREATE_TARGET
  ...
  ADD_CUSTOM_TARGET(pmmg2dtypes_header ALL
    DEPENDS
    ${source_dir}/libparmmg2dtypes.h )

  ADD_CUSTOM_TARGET(pmmg2dversion_header ALL
    DEPENDS
    ${binary_dir}/pmmg2dversion.h )

  ADD_CUSTOM_TARGET(pmmg2d_header ALL
    DEPENDS
    ${source_dir}/libparmmg2d.h )

  COPY_HEADER (
    ${source_dir} libparmmg2dtypes.h
    ${include_dir} libparmmg2dtypes.h
    pmmg2dtypes_header copy_libpmmg2dtypes )

  COPY_HEADER (
    ${binary_dir} pmmg2dversion.h
    ${include_dir} pmmg2dversion.h
    pmmg2dversion_header copy_pmmg2dversion )

  COPY_HEADER (
    ${source_dir} libparmmg2d.h
    ${include_dir} libparmmg2d.h
    pmmg2d_header copy_libpmmg2d
    )

  COPY_HEADER (
    ${binary_dir} libparmmg2dtypesf.h
    ${include_dir} libparmmg2dtypesf.h
    pmmg2dtypes_fortran_header copy_libpmmg2dtypesf )

  COPY_HEADER (
    ${binary_dir} libparmmg2df.h
    ${include_dir} libparmmg2df.h
    pmmg2d_fortran_header copy_libpmmg2df
    )

  SET ( tgt_list  copy_libpmmg2df copy_libpmmg2dtypesf
    copy_libpmmg2d copy_libpmmg2dtypes copy_pmmg2dversion)

  IF (NOT WIN32 OR MINGW)
    COPY_HEADER (
      ${binary_dir} git_log_pmmg2d.h
      ${include_dir} git_log_pmmg2d.h
      GenerateGitHash copy_pmmgg2dithash )

    LIST ( APPEND tgt_list copy_pmmgg2dithash)
  ENDIF ()

  ADD_CUSTOM_TARGET(copy_pmmg2d_headers ALL
    DEPENDS ${tgt_list})
...
MACRO ( ADD_AND_INSTALL_LIBRARY
  ...
  install(TARGETS ${target_name} EXPORT ParMmg2dTargets
...
MACRO ( ADD_AND_INSTALL_EXECUTABLE
 ...
 ENDIF ( )
  ...
  INSTALL(TARGETS ${exec_name}
    EXPORT ParMmg2dTargets RUNTIME DESTINATION bin COMPONENT appli)
